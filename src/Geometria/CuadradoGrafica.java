 ...
 * @author T-301
 */
public class CuadradoGrafica extends javax.swing.JFrame {

    /**
     * Creates new form CuadradoGrafica
     */
    public CuadradoGrafica() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CuadradoGrafica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CuadradoGrafica().setVisible(true);
            }
        });
    }
